...
The shell is styled to the **IMC Blue Design System** (claude.ai/design project
`ad736cbc-bf46-47ec-843a-2a982aa72ac6`): Fraunces for headings/stat numerals, Inter for
UI, IMC Blue `#0284c7` as the brand accent, semantic light/dark tokens. If the design
...
chips in the template (IMC Blue intent tokens: success / primary / warning / destructive;
